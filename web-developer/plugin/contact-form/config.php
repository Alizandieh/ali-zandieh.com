<?php
    ...
    define('CONTACT_FORM_TO_NAME','Ali Zandieh');
    define('CONTACT_FORM_TO_EMAIL','ali.zandieh@gmail.com');
    ...
    define('CONTACT_FORM_SUBJECT','MY Site: Contact form');
    ...
    define('CONTACT_FORM_SEND_MSG_OK','Thank you for contacting. I will get back to you as soon as possible.');
